...
const HeroHeaderSection = () => {
  ...
  return (
    <div className="pt-10 flex flex-col md:flex-row items-center bg-gradient-to-br from-blue-50 via-white to-purple-50 rounded-4xl p-6 ">
      ...
      {/* <div className="text-center justify-self-center items-center flex md:w-3/12">
